      ...
      <div class="col-md-10">
          <div class="card shadow">
              <div class="card-header">
                  <h4 class="card-title" id="horz-layout-basic">Booking Details For : <b style="color: red;"><?php echo $booked_space['title']; ?></b></h4>
              </div>
              	...
              	<table class="table table-striped table-inverse">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><?php echo ucfirst($space_details['my_fname'])." ".ucfirst($space_details['my_lname'])?></td>
                        </tr>
                        <tr>
