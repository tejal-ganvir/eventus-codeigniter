        ...
        <form id="myaccount" method="POST" action="<?php echo base_url();?>home/myaccount/<?php if($user_details){ echo $user_details['unique_id'] ;}?>" enctype="multipart/form-data">
          ...
          <?php
               ...
               ?>
              <img class="img-circle" src="<?php echo base_url().$CustPhoto;?>" class="blah" width="150" height="150" /><?php } ?>
          </div>
          <div class="row">
            <div class="col-md-6 col-xs-7"><h3 style="color:#78F7E0">My Account</h3></div>
            <div class="col-md-6 col-xs-5" ><a href="javascript:;" style="float:right; color: #65D0BD; font-size: 31px;" name="edit" value="edit" onclick="enableInput()" class="fa fa-edit">Edit</a></div>
            </div>
            <br>
            <?php 
          ...
          <div class="col-md-offset-4 col-md-6" style="padding-top: 20px;">
...
<script type="text/javascript">
    ...
    <script type="text/javascript">
      function enableInput(){
       ...
       $("input[name='profile_pic']").css('background-color','transparent');
