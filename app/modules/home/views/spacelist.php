                            ...
                            <div class="col-md-12 my-listing-dashboard">
                                ...
                                <div class="table-head">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3"><span class="th-title">Action</span></div>
                                    </div>
                                </div>
                                <?php 
                                  if($spacelist)
                                ...
                                <div class="listing-row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 listing-action">
                                          <a href="<?php echo base_url();?>home/editspace/<?php echo $spacelist[$i]->unique_id;?>" class="btn btn-primary  btn-xs">Edit</a> 
                                          <a href="<?php echo base_url();?>home/spacedetail_host/<?php echo $spacelist[$i]->unique_id;?>" class="btn btn-danger btn-xs">View</a>
                                          <a href="<?php echo base_url();?>home/kyc_ofspace/<?php echo $spacelist[$i]->space_id;?>" class="btn btn-warning btn-xs">Documents</a></div>
                                    </div>
                                </div>
                                <?php
                                    }
