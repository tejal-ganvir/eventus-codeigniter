            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="page-header">
                        <h1 style="font-size: 52px;font-weight: bolder;"><?php echo $booked_service['company']; ?></h1>
                    </div>
                </div>
            </div>
        </div>
                                  ...
                                  <tbody>
                                        ...
                                        <div class="col-md-8 col-md-offset-2">
                                          <div class="profile-sidebar side-box" style="border:none; padding: 0; margin: 0;">
                                            <div class="profile-usertitle-name">
                                              ...
                                              <!-- SIDEBAR USERPIC -->
                                              <?php 
                                              $CustPhoto = $booked_service['profile_image']?'uploads/profile_pic/'.$booked_service['profile_image']:"themes/frontend/images/no-image.png";
                                             ?>
                                              <div class="profile-userpic"> <img src="<?php echo base_url().$CustPhoto;?>" class="img-responsive img-circle" alt=""> </div>
                                              <div class="profile-usertitle">
                                                  <div class="profile-usertitle-name">
                                                      <h2> <?php echo $booked_service['fname']." ".$booked_service['lname'] ; ?></h2>
                                                  </div>
                                                  <div class="profile-address"> <i class="fa fa-phone"></i> <a href="tel:<?php echo $booked_service['mobileno']; ?>"><?php echo $booked_service['mobileno']; ?></a> </div>
                                                  <div class="profile-website"> <i class="fa fa-envelope"></i> 
                                                    <span class="text-muted">
                                                      <?php echo $booked_service['email_id']; ?>
                                                    </span>
                                                   </div>
                                                  <div class="profile-website"> <i class="fa fa-map-marker"></i> 
                                                    <span class="text-muted">
                                                      <?php echo $booked_service['address']; ?>
                                                    </span>
                                                   </div>
                                                   <div class="profile-website"> <i class="fa fa-briefcase"></i> 
                                                    <span class="text-muted">
                                                      <?php echo $booked_service['company_name']; ?>
                                                    </span>
                                                   </div>
                                              </div>
                                          </div>
                                    ...
                                    <tr>
                                      <td colspan="2" class="text-center">
                                        ...
                                        $is_disable = "";
                                        $is_disable2 = "";
                                        if($booked_service['chk_status'] == 3){
                                          $is_disable2 = "disabled";
                                        }
                                        // if ($booked_service['chk_status'] == 1 || $booked_service['chk_status'] == 2 ) {
                                        //     $today = date("m/d/Y H:i");
                                        //     $enddate = date("m/d/Y", strtotime($booked_service['enddate']));
                                        //     $event_end= explode(" ", $booked_service['end_time']);
                                        ...
                                        //     }
                                        if($booked_service['chk_status'] == 1 || $booked_service['chk_status'] == 2 || $booked_service['chk_status'] == 3){
                                          if($booked_service['chk_status'] == 2){
                                              $is_disable = "disabled";
                                              $text = "Complete Request";
                                            }
                                      ...
                                      <?php } ?>
                                        ...
                                        <button onclick="window.location.href ='<?php echo base_url();?>home/edit_servicebooking_details/<?php echo $unique_id."/".$booked_service['service_booking_id'];?>'" class="btn btn-warning" id="upd" style="margin: 5px;" <?php echo $is_disable2; ?> >Update Details</button>
                                        ...
                                        <input type="hidden" id="booking_id" value="<?php echo $booked_service['service_booking_id'];?>">
                                      </td>
                                    </tr>
