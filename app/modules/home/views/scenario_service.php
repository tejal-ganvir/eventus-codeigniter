                    ...
                    <div class="filter-box" id="searchform">
                        <div class="container-fluid">
                            <div class="row filter-form">
                                ...
                                <form id="search_form" method="post" action="<?php echo base_url();?>home/scenario_service">
                                    ...
                                    <div class="col-md-3">
                                        <label class="control-label" for="capacity">Select Guests</label>
                                         <select class="form-control"  name="guest" id="guest" onchange="$('#search_form').submit()">
                                          <option value="0" disabled="" selected="">Select Guests</option>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 vendor-box mylocation" data-lat="<?php echo $service_list[$i]->lat ?>" data-lon="<?php echo $service_list[$i]->lon ?>">
                        ...
                        <div class="vendor-detail">
                            ...
                            <div class="caption">
                                <!-- caption -->
                                <h2><a href="<?php echo base_url();?>home/view_service_details/<?php echo $service_list[$i]->uni."/".$service_list[$i]->service_details_id ?>" class="title" target="_blank"><?php echo $service_list[$i]->company ?></a></h2>
