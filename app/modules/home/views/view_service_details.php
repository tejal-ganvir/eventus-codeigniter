                ...
                <div class="col-md-8">
                    <div class="side-box" id="inquiry">
                      ...
                      <form method="post" action="<?php echo base_url();?>home/booked_service/<?php echo $service_detail['uni_id']; ?>" id="submit_form">
                          ...
                          <input type="hidden" name="service_id" id="service_id" value="<?php echo $service_detail['service_details_id'] ?>">
                            <!-- Text input-->
                            ...
                            <div class="col-md-12">
                                ...
                                <div >
                                  ...
                                  <span style="float: right;">₹ <b id="estimated">0</b></span>
                                </div>
                              </div>
                            ...
                            <div class="form-group text-center">
                                ...
                                <button type="button" class="btn btn-default btn-lg " onclick="window.location.replace('<?php echo base_url();?>home/scenario_service');">Back to search</button>
                            </div>
                        </form>
                    </div>
                </div>
...
<script type="text/javascript">
    $('#send_button').click(function(e) {
      ...
      if (package == null) {alert_pop('Please select an event!'); return false;}
      ...
      if (time_array != null) {
          ...
          success : function(data){
            if (data == 1) {
              ...
              $.ajax({
                      type: "POST",
                      url: "<?php echo base_url();?>home/cart_service",
                      data: { service_id: service_id,user_id: user_id, package_id:package, guest_id:guests, startdate:startdate, enddate:enddate, start_time:start_time, end_time:end_time, amount:total_amount},
                      success: function(result) {
                        result = parseInt(result);
                        //alert(result);
                        if(result > 0) {

                          $('#send_button').text('Added To Cart');
                          $('#send_button').addClass('disabled');
                          $('#submit_form')[0].reset();
                          $("#base_price1").text(package_price);
                          $("#base_price").text(package_price);
                          $("#estimated").text('0');
                          return false;
                        }
                      }
    ...
    $("#my-datepicker2").datepicker({
        ...
        onClose: function (selectedDate) {
           ...
           var mytotal = $("#total_amount").val();
            //////////// DECIDE AMOUNT //////////////
            $("#base_price1").text(mytotal +' x '+days);
            $("#base_price").text(mytotal * days);
            $("#estimated").text(mytotal * days);
