        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 side-nav" id="leftCol">
                    <div class="hide-side">
                        <ul class="listnone nav" id="sidebar">
                            ...
                            <li><a href="<?php echo base_url();?>home/space_request">Space Bookings</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-9 content-right profile-dashboard">
                    ...
                    ?>
                    <form id="space_form" method="POST" action="<?php echo base_url();?>home/kyc_ofspace" enctype="multipart/form-data">
                      <div class="col-md-6">
                              ...
                              <div class="vendor-img">
                                  <div id="viewer">
                                    <?php 
                                      ...
                                      ?>
                                      <embed src="<?php echo base_url();?>uploads/space_documents/<?php echo $documents['id_proof'] ?>" >
                                      <?php }else{ ?>
                      ...
                      <div class="col-md-6">
                          <div class="vendor-list-block mb30">
                              ...
                              <div class="vendor-img">
                                  <div id="pdfviewer">
                                    <?php 
                                      if (!empty($documents['space_proof'])) {
                                    ?>
                                      <embed src="<?php echo base_url();?>uploads/space_documents/<?php echo $documents['space_proof'] ?>" >
                                      <?php }else{ ?>
                                      <img src="<?php echo base_url();?>themes/frontend/images/preview.jpg" id="pre_spcimg">
                                    <?php } ?>
                                  </div>
                                  <div class="category-badge">
                                    <input type="file" name="space_proof" id="space_proof" value="<?php if($documents){ echo $documents['space_proof']; }?>" my-data="<?php if($documents){ echo $documents['space_proof']; }?>">
                                  </div>
                              </div>
                              <div class="vendor-detail">
                                  <!-- vendor details -->
                                  <div class="caption">
                                      <h2><font color="red">*</font> Space Proof:</h2>
                                      <div class="vendor-meta"> 
...
<script type="text/javascript">
  ...
  $('#space_proof').change(function (event) {
    var val = $("#space_proof").val();
      if (!val.match(/(?:gif|jpg|png|bmp|pdf)$/)) {
  ...
  $('#send_button').click(function(){
      ...
      var spcval = $("#space_proof").val();
      var data_spcval = $("#space_proof").attr('my-data');
      if (spcval == '' && data_spcval == '') {
          $('#valid_spc').text('Please upload space proof');
          return false;
      }else{
