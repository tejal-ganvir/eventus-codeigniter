	...
	<div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="side-box" id="inquiry">
                      ...
                      <form method="post" action="<?php echo base_url();?>home/update_booked_space/<?php echo $booked_space['space_booking_id']; ?>" id="submit_form">
                            <!-- Text input-->
                                ...
                                <div class="col-md-6" style="margin-bottom: 20px;">
                                    ...
                                    <div class="">
                                        <div class="input-group">
                                            <input type="text" class="form-control dpicker" name="startdate" placeholder="Start Date" autocomplete="off" id="my-datepicker" placeholder="Wedding Date" value="<?php if($booked_space){ echo $booked_space['startdate']; } ?>">
                                      ...
                                      for ($l=0; $l < count($timings); $l++) 
                                          ...
                                          ?>
                                            ...
                                            <?php
                                              ...
                                              if($timings[$l]->value == $booked_space['start_time']){
                                              	echo "selected";
                                              }
                                            ?>>
                            ...
                            <div class="default-calender">
                                <div class="col-md-6" style="margin-bottom: 20px;">
                                    ...
                                    <div class="">
                                        <div class="input-group">
                                            <input type="text" class="form-control dpicker" name="enddate" placeholder="End Date" autocomplete="off" id="my-datepicker2" placeholder="Wedding Date" value="<?php if($booked_space){ echo $booked_space['enddate']; } ?>">
                                            <span class="input-group-addon" id="basic-addon2"><i class="fa fa-calendar"></i></span> </div>
                                    </div>
                                        ...
                                        for ($l=0; $l < count($timings); $l++) 
                                            ...
                                            ?>
                                              ...
                                              <?php
                                                ...
                                                if($timings[$l]->value == $booked_space['end_time']){
                                              	echo "selected";
                                              }
                            ...
                            <div class="col-md-12" style="margin-bottom: 20px;">
                                ...
                                <div class="">
                                	<input type="text" name="amount" class="form-control" required="" onkeypress="return isNum(event)" placeholder="Enter Amount" value="<?php if($booked_space){ echo $booked_space['amount']; } ?>">
                                </div>
                            <hr>
                            </div>
...
$(function () {
    ...
    $("#my-datepicker2").datepicker({
        ...
        onClose: function (selectedDate) {
            ...
            //$("#TextBox3").val(days);
            //////////// DECIDE AMOUNT //////////////
            $("#base_price1").text('<?php echo $space_detail['base_price']; ?> x '+days+' days');
            ...
            var discount = 100-<?php echo $space_detail['discount']; ?>;
            var final = (discount/100) * (<?php echo $space_detail['base_price']; ?> * days);
