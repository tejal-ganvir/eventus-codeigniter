		  ...
		  <div class="row well">
			...
			<h5 style="color:#66727f">When is your activity taking place?</h5><br> 
				...
				<!-- <div class="row">
					...
					<div class="col-lg-12">
						<div class="myinput">
			              <input type="text" class="validate[required] text-input" name="enddate" value="" placeholder="End Date" readonly>
			            </div>
					</div>
					<div class="col-lg-6">
						<div class="myinput">
			...
			<div class="col-lg-4"> 
				<div id="slider">
				  ...
				  <ul>
				    ...
				    <li><img  src="<?php echo base_url();?>uploads/space_image/<?php echo $space_image[$k]->name; ?>" class="img-fluid" alt=""width="100%"/> </li>
				    <?php 
				        }
				      }
				    ?>
				...
				<div style="padding: 10px 10px 10px 20px; border: 1px solid #449E8E; border-radius: 20px; ">
					<p style="color:#000; font:bolder; font-size:22px; font-family: 'Times New Roman', Times, serif;"><?php if($space_detail){ echo $space_detail['title'];}?></p>
					<p style="color:#000; font:bolder; font-size:18px; font-family: 'Times New Roman', Times, serif;"><?php if($space_detail){ echo $space_detail['landmark']." ".$space_detail['my_add'];}?> &nbsp; </p>
					<!-- <p style="color:#000; font:bolder; font-size:18px; font-family: 'Times New Roman', Times, serif;">Booked For: </p> -->
				</div>
				...
				<table>
					...
					<tr>
						<td>Space Price:</td>
						<td>₹ <?php echo $space_detail['base_price']; ?></td>
					</tr>
					<tr>
						<td>Service Fee:</td>
						<td>₹ 500</td>
					...
					<tr>
						...
						<td>₹ <?php echo $space_detail['base_price']+400; ?></td>
					</tr>
				</table>
				<br>
				<h6>What's Next?</h6>
				<p>
					The space owner has 2 business days to confirm or decline your request, if the owner declines or dosent respond, and you will not charged. Your booking is subject to the cancellation and refund policy set by the space provider.
				</p>
				<br>
