            ...
            <div class="row">
                <div class="col-md-8">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo base_url();?>home/search_scenario">Scenario Search</a></li>
                        <li class="active">All Spaces</li>
                    </ol>
                </div>
                    ...
                    <div class="filter-box" id="searchform">
                        <div class="container-fluid">
                            <div class="row filter-form">
                                ...
                                <form id="search_form" method="post" action="<?php echo base_url();?>home/scenario_space">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        <input  type="text" id="my-datepicker" name="startdate" class="form-control dpicker" placeholder="Start Date" value="<?php if($startdate){ echo $startdate ;}else{ echo date('m/d/Y') ;}?>" >
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-control" name="budget" id="budget" onchange="$('#search_form').submit()">
                                          ...
                                          <option value="1-1000" <?php if($budget){ if($budget == "1-1000"){ echo "Selected" ;}}?>>>₹1000</option>
                                          <option value="1000-3000" <?php if($budget){ if($budget == "1000-3000"){ echo "Selected" ;}}?>>₹1000-₹3000</option>
                                          <option value="3000-6000" <?php if($budget){ if($budget == "3000-6000"){ echo "Selected" ;}}?>>₹3000-₹6000</option>
                                          <option value="6000-10000" <?php if($budget){ if($budget == "6000-10000"){ echo "Selected" ;}}?>>₹6000-₹10000</option>
                                          <option value="10000" <?php if($budget){ if($budget == "10000"){ echo "Selected" ;}}?>>₹10000 +</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <option value="" disabled="" selected="">Select Event</option>
                                         <?php 
                                          if($events)
                                          {
                                            ...
                                            {   
                                            ?>
                                              <option value="<?php echo $events[$i]->event_id?>"<?php if($event){ if($event == $events[$i]->event_id){ echo "Selected" ;}}?>><?php echo $events[$i]->event_name?></option>
                                              <?php
                                            }
                                          }
                                        ?>
