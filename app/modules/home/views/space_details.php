        ...
        <div class="container tabbed-page st-tabs">
            <div class="row tab-page-header">
                ...
                <div class="col-md-4 venue-data">
                    ...
                    <a href="#inquiry" class="btn btn-default btn-lg btn-block">Book Space</a> </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <!-- Nav tabs -->
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="side-box" id="inquiry">
                        <h2>Book Now</h2>
                        <p>Fill in your details and a Space Specialist will get back to you shortly.</p>
                        <?php
                      ...
                      <form method="post" action="<?php echo base_url();?>home/booked_space/<?php echo $space_detail['uni_id']; ?>" id="submit_form">
                          ...
                          <input type="hidden" name="space_id" value="<?php echo $space_detail['space_id'] ?>">
                            <!-- Text input-->
                            <div class="col-md-12" style="margin-bottom: 20px;">
                                <label class="control-label" for="name-one">Events:<font class="required">*</font></label>
                                <div class="">
                                    <select class="form-control"   name="event_id" id="eventss" required="">
                                      <?php 
                                        for ($m=0; $m < count($space_event); $m++) 
                                            { 
                                        ?>
                                          <option value="<?php echo $space_event[$m]->event_id?>" data-price="<?php echo $space_event[$m]->event_price; ?>" <?php if($m == 0){ echo "selected"; }?>><?php echo $space_event[$m]->event_name?></option>
                                          <?php
                                        //}
                                      }
                                    ?>
                            ...
                            <div class="col-md-12">
                              <div class="input-container" style="border-bottom: 1px solid #ccc; border-top: 1px solid #ccc; padding: 10px 0; margin-top: 15px; font-style: italic;">
                                 <div >
                                  <span style="float: left;">Space Price: ₹ <b id="base_price1">0</b></span>
                                  <span style="float: right;">₹ <b id="base_price">0</b></span>
                                </div>
                                <br>
                                <?php if($space_detail['discount'] > 0){ ?>
                                <div >
                                  <span style="float: left;">Discount Offered:</span>
                                  <span style="float: right;"><b><?php echo $space_detail['discount'] ?> %</b></span>
                                </div>
                                <br>
                                <div >
...
<script type="text/javascript">
  var conceptName = $('#eventss').find(":selected").attr('data-price');
...
<script type="text/javascript">
    $('#send_button').click(function() {
      ...
      var events = $('#eventss option:selected').val();
      ...
      var uni_id = '<?php echo $space_detail['uni_id']; ?>';
      var table = 'space';
        if (user_id == 0 ) {
      ...
      if (events == null) {alert_pop('Please select an event!'); window.scrollBy(0, -200); return false;}
